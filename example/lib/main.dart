        ...
        child: Center(
          child: Column(
            children: [
              ...
              SizedBox(height: 40),
              AdaptiveSpinner(withSizedBox: 100, withMessage: 'With SizedBox (width: 100)'),
              SizedBox(height: 40),
              AdaptiveSpinner(withStyle: TextStyle(fontSize: 15, fontWeight: FontWeight.bold), withMessage: 'With message and styled text'),
            ],
          ),
        ),
      ),
